...
// Removed chef_ui_kit import

/// Step 2 of the verification wizard: confirm the kitchen's pickup
/// location on a real map.
class DriverLocationSetupScreen extends StatefulWidget {
  const DriverLocationSetupScreen({super.key});

  @override
  State<DriverLocationSetupScreen> createState() => _DriverLocationSetupScreenState();
}

class _DriverLocationSetupScreenState extends State<DriverLocationSetupScreen> {
  final MapController _mapController = MapController();
  final TextEditingController _searchController = TextEditingController();

  LatLng _currentCenter = const LatLng(24.0889, 32.8998); // Default to Aswan, Egypt
  String _addressName = 'موقعي';
      ...
      body: Column(
        children: [
          const Padding(
            ...
            child: Text('تحديد منطقة التوصيل', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          ),
          Expanded(
            child: Stack(
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          _isLoadingAddress ? 'جاري التحديد...' : 'منطقة العمل',
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              hintText: 'ابحث عن منطقة التوصيل...',
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('تحديد منطقة التوصيل',
                              style: AppTextStyles.titleLg.copyWith(
                                  color: AppColors.textOf(brightness))),
                          Text(
                            'قم بتأكيد النقطة لاستقبال الطلبات القريبة.',
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              _isLoadingAddress ? 'جاري التحديث...' : _addressName,
                              style: AppTextStyles.titleMd.copyWith(
                                  color: AppColors.textOf(brightness)),
                            ),
                            Text(
                              _isLoadingAddress ? 'يرجى الانتظار...' : _addressDetails,
                              style: AppTextStyles.bodySm.copyWith(
                                  color: AppColors.textMutedOf(brightness)),
                            ),
                          ],
